...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Pemberian Pakan', href: '/kolam-feeding' },
    { title: 'Tambah Pemberian Pakan', href: '/kolam-feeding/create' },
];
            ...
            <div className="max-w-full mx-auto p-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white dark:bg-neutral-900 rounded-md shadow-sm p-6">
                        <h2 className="text-xl font-semibold mb-4">Form Pemberian Pakan</h2>
