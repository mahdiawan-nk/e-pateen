...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit Monitoring', href: '/kolam-monitoring' }, // tidak perlu url create
];
...
export default function Update({ kolam_options, user_role, user_kolam_ids, monitoring }: Props) {
    const form = useForm({
        kolam_id: monitoring.kolam_id,
        date: monitoring.date,
        water_temp_c: monitoring.water_temp_c,
        ph: monitoring.ph,
        oxygen_mg_l: monitoring.oxygen_mg_l,
        ammonia_mg_l: monitoring.ammonia_mg_l,
        turbidity_ntu: monitoring.turbidity_ntu,
        remarks: monitoring.remarks,
    });
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        form.put(`/kolam-monitoring/${monitoring.id}`, {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Edit Monitoring Kolam" />
            ...
            <div className="max-w-6xl mx-auto p-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white dark:bg-neutral-900 rounded-md shadow-sm p-6">
                        <h2 className="text-xl font-semibold mb-4">Form Edit Monitoring Kolam</h2>
