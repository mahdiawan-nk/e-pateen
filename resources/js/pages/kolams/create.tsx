...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah Kolam', href: '/kolams/create' },
];
...
export default function Create({
    ...
    const form = useForm({
        ...
        owner_id: user_role === 'administrator' ? '' : user_id,
    });

    const [autoVolume, setAutoVolume] = useState(0);
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        form.post('/kolams', { onSuccess: () => router.get('/kolams') });
    };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="max-w-6xl mx-auto p-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    {/* ================== FORM ================== */}
                    <div className="bg-white dark:bg-neutral-900 rounded-xl shadow-md p-6 space-y-6">
                        <h2 className="text-2xl font-semibold text-neutral-800 dark:text-neutral-100">Form Tambah Kolam</h2>
                    ...
                    {/* ================== CARD INFO ================== */}
                    <div className="bg-neutral-50 dark:bg-neutral-800 rounded-xl shadow-md p-6 space-y-4">
                        <h3 className="text-lg font-semibold text-neutral-800 dark:text-neutral-100">Panduan Pengisian & Informasi Kolam</h3>
                        ...
                        <div className="space-y-2 text-sm text-neutral-700 dark:text-neutral-200">
                            ...
                            <ul className="list-disc list-inside ml-4 space-y-1">
                                <li><span className="font-medium">Idle:</span> Kolam kosong / siap budidaya.</li>
                                <li><span className="font-medium">Stocking:</span> Kolam baru diisi benih ikan.</li>
                                <li><span className="font-medium">Nursery:</span> Pemeliharaan benih kecil.</li>
                                <li><span className="font-medium">Growing:</span> Pemeliharaan ikan sampai siap panen.</li>
                                <li><span className="font-medium">Harvest:</span> Kolam siap panen / sedang dipanen.</li>
                            </ul>
                            ...
                            <p>
                                ...
                                <ul className="list-disc list-inside ml-4 space-y-1 mt-1">
                                    ...
                                    <li>Pilih Jenis Kolam, Kondisi Kolam & Status Produksi.</li>
